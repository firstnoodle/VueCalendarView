<template>
    <button @click="$emit('click')">
        <svg v-if="icon === 'double-left'" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg v-if="icon === 'single-left'" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M11.7071 14L11 14.7071L4.29289 8L11 1.29289L11.7071 2L5.707 8L11.7071 14Z" fill="black"/>
        </svg>
        <svg v-if="icon === 'single-right'" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M4.29289 14L5 14.7071L11.7071 8L5 1.29289L4.29289 2L10.293 8L4.29289 14Z" fill="black"/>
        </svg>
        <svg v-if="icon === 'double-right'" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    props: {
        icon: {
            ...
            validator: function(value) {
                return ['single-left', 'single-right', 'double-left', 'double-right'].indexOf(value) !== -1;
            }
        }
    }
}
